...
public class SearchTreeWindow extends Window {
	
	private Logger logger = Logger.getLogger(SearchTreeWindow.class.getName());
	...
	public SearchTreeWindow() {
		setPixelSize(700, 450);
		setModal(true);
		//setBlinkModal(true);
		setHeadingText("Search taxa in tree");
		getHeader().setIcon(Resources.INSTANCE.search());
	      ...
	      view.setCell(new AbstractCell<Forum>() {
			...
			public void render(com.google.gwt.cell.client.Cell.Context context,
					Forum value, SafeHtmlBuilder sb) {
	      ...
	      combo.addBeforeSelectionHandler(new BeforeSelectionHandler<Forum>() {
	        ...
	        public void onBeforeSelection(BeforeSelectionEvent<Forum> event) {
	          ...
	          com.google.gwt.user.client.Window.open("http://sencha.com/forum/showthread.php?t=" + f.getTopicId() + "&p=" + f.getPostId(), null, null);
	        }
	      });
